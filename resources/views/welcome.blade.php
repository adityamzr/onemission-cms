   ...
   <div class="fixed top-0 bottom-0 z-20 hidden lg:flex flex-col shrink-0 w-[--tw-sidebar-width] bg-[--tw-page-bg] dark:bg-[--tw-page-bg-dark]" data-drawer="true" data-drawer-class="drawer drawer-start flex top-0 bottom-0" data-drawer-enable="true|lg:false" id="sidebar">
    ...
    <div class="flex flex-center justify-between shrink-0 ps-4 pe-3.5 mb-3.5" id="sidebar_footer">
      ...
      <div class="menu-item" data-menu-item-offset="-10px, 15px" data-menu-item-placement="right-end" data-menu-item-toggle="dropdown" data-menu-item-trigger="click|lg:click">
       ...
       <div class="menu-dropdown menu-default light:border-gray-300 w-screen max-w-[250px]">
         ...
         <div class="flex items-center gap-2">
          <img alt="" class="size-9 rounded-full border-2 border-success" src="assets/media/avatars/300-2.png">
           <div class="flex flex-col gap-1.5">
            ...
            <a class="text-xs text-gray-600 hover:text-primary font-medium leading-none" href="html/demo6/account/home/get-started.html">
             c.fisher@gmail.com
            </a>
           </div>
          </img>
        ...
        <div class="flex flex-col">
         ...
         <div class="menu-item">
          <a class="menu-link" href="html/demo6/account/home/user-profile.html">
           <span class="menu-icon">
            <i class="ki-filled ki-profile-circle">
            </i>
           </span>
         ...
         <div class="menu-item" data-menu-item-offset="-50px, 0" data-menu-item-placement="left-start" data-menu-item-placement-rtl="right-start" data-menu-item-toggle="dropdown" data-menu-item-trigger="click|lg:hover">
          ...
          <div class="menu-dropdown menu-default light:border-gray-300 w-full max-w-[220px]">
           <div class="menu-item">
            <a class="menu-link" href="html/demo6/account/home/get-started.html">
             <span class="menu-icon">
           ...
           <div class="menu-item">
            <a class="menu-link" href="html/demo6/account/security/overview.html">
             <span class="menu-icon">
           ...
           <div class="menu-item">
            <a class="menu-link" href="html/demo6/account/members/teams.html">
             <span class="menu-icon">
           ...
           <div class="menu-item">
            <a class="menu-link" href="html/demo6/account/integrations.html">
             <span class="menu-icon">
        ...
        <div class="flex flex-col">
         ...
         <div class="menu-item px-4 py-1.5">
          <a class="btn btn-sm btn-light justify-center" href="html/demo6/authentication/classic/sign-in.html">
           Log out
          </a>
         </div>
        </div>
     ...
     <div class="flex items-center gap-1.5">
      ...
      <a class="btn btn-icon btn-icon-lg size-8 hover:bg-light hover:text-primary text-gray-600" href="html/demo6/authentication/classic/sign-in.html">
           ...
           <div class="card h-full">
            <div class="card-body flex flex-col place-content-center gap-5">
             ...
             <div class="flex flex-col gap-4">
              ...
              <div class="flex justify-center">
               <a class="btn btn-primary" href="html/demo6/public-profile/teams.html">
                Create Team
               </a>
              </div>
             </div>
             ...
             <div class="menu" data-menu="true">
              <div class="menu-item" data-menu-item-offset="0, 10px" data-menu-item-placement="bottom-start" data-menu-item-toggle="dropdown" data-menu-item-trigger="click|lg:click">
               ...
               <div class="menu-dropdown menu-default w-full max-w-[200px]" data-menu-dismiss="true">
                <div class="menu-item">
                 <a class="menu-link" href="html/demo6/account/activity.html">
                  <span class="menu-icon">
             ...
             <div class="flex flex-col gap-5">
              <div class="flex items-center justify-between gap-2.5">
               <div class="flex items-center gap-2.5">
                ...
                <div class="flex flex-col gap-0.5">
                 <a class="flex items-center gap-1.5 leading-none font-medium text-sm text-gray-900 hover:text-primary" href="html/demo6/public-profile/teams.html">
                  Esther Howard
                 </a>
