                                    ...
                                    <thead>
                                        ...
                                        <tr>
                                            ...
                                            <td class="flex items-center gap-2">
                                                <button type="button"  wire:click="$dispatchTo('categories.category-form', 'openModal', { id: {{ $item->id }} })" class="btn btn-warning btn-sm">
                                                    <i class="ki-filled ki-pencil">
                                                    </i>
                                                    Edit
                                                </button>
                                                <button type="button" wire:confirm="Are you sure you want to delete this data?" wire:click="$dispatchTo('categories.category-form', 'destroy', { id: {{ $item->id }} })" class="btn btn-danger btn-sm">
