                    ...
                    <div class="w-full py-5 md:py-10 px-4 md:px-8">
                        <div class="flex flex-col space-y-3">
                            ...
                            <div class="flex flex-col justify-center gap-2">
                                <div class="flex items-center justify-center size-60 mb-4 rounded-lg bg-gray-200 border border-gray-300 shadow-none">
                                    @if ($url)
                                    @php
                                ...
                                <input type="file" wire:model="url" class="file-input w-60" accept=".jpg,.jpeg,.png,.webp">
                            </div>
