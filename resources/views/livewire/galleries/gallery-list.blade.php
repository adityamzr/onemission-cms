    ...
    <main class="grow" role="content">
        ...
        <div class="container-fixed flex items-center justify-between flex-wrap gap-3">
            ...
            <div class="flex items-center flex-wrap gap-1.5 lg:gap-3.5">
                ...
                <button type="button" wire:click="$dispatchTo('galleries.gallery-form', 'openModal')" class="btn btn-dark">
        ...
        <div class="container-fixed">
            ...
            <div class="grid">
                ...
                <div id="projects_cards">
                    ...
                    @endif
                    <div class="grid grid-cols-1 lg:grid-cols-3 xl:grid-cols-5 gap-5 py-10">
                        {{-- begin: items --}}
                                    ...
                                    <div class="dropdown" data-dropdown="true" data-dropdown-placement="bottom-end" data-dropdown-placement-rtl="bottom-start" data-dropdown-trigger="click">
                                        ...
                                        <div class="dropdown-content menu-default w-full max-w-36">
                                            <div class="menu-item" data-dropdown-dismiss="true">
                                                <button wire:click="$dispatchTo('galleries.gallery-form', 'openModal', { id: {{ $item->id }} })" class="menu-link">
                    ...
                    {{ $galleries->links('vendor.livewire.tailwind') }}
                    </div>
                </div>
                <!-- end: cards -->
            </div>
        ...
        <!-- End of Container -->
        @livewire('galleries.gallery-form')
    </main>
</div>
