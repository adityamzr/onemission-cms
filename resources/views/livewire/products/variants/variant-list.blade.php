                            ...
                            <div class="scrollable-x-auto">
                                <table class="table table-auto table-border align-middle text-gray-700 font-medium text-sm" data-datatable-table="true">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="text-center">{{ $variants->firstItem() + $key }}</td>
                                            <td class="text-center">
                                                {{-- @dd($variants[4]->images[0]->image_url) --}}
                                            ...
                                            <td class="space-y-2">
                                                <div class="badge {{ $item->is_active ? 'badge-success' : 'badge-danger' }} rounded-md">{{ $item->is_active ? 'Active' : 'Inactive' }}</div>
                                            ...
                                            <td class="text-center space-y-2">
                                                ...
                                                <button wire:click="deleteVariant('{{ $item->id }}')" wire:confirm="Are you sure you want to delete this data?" type="button" class="btn btn-danger btn-sm">
