    ...
    <main class="grow" role="content">
        ...
        <div class="container-fixed flex items-center justify-between flex-wrap gap-3">
            ...
            {{-- <div class="flex items-center flex-wrap gap-1.5 lg:gap-3.5">
                ...
                <button type="button" wire:click="$dispatchTo('payments.order-form', 'openModal')" class="btn btn-dark">
                                ...
                                <table class="table table-auto table-border align-middle text-gray-700 font-medium text-sm" data-datatable-table="true">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">{{ $item->order->email }}</td>
                                            <td class="text-center">{{ $item->order->phone }}</td>
                                            <td class="text-center capitalize">{{ str_replace('_', ' ', $item->payment_method) }}</td>
                                            <td class="text-center">{{ formatRupiah($item->amount) }}</td>
                                            ...
                                            <td class="flex items-center gap-2 sticky right-0 bg-white z-10 border-l">
                                                <button type="button"  wire:click="$dispatchTo('payments.payment-detail', 'openModal', { id: {{ $item->id }} })" class="btn btn-primary btn-sm">
        ...
        <!-- End of Container -->
        {{-- @livewire('payments.payment-detail') --}}
    </main>
</div>